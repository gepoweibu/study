...
public class Cell_OverrideHashCode {
	private int x;
	private int y;

	public Cell_OverrideHashCode(int x, int y) {
		this.x = x;
		this.y = y;
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof Cell_OverrideHashCode && this.x == ((Cell_OverrideHashCode) obj).getX()
				&& this.y == ((Cell_OverrideHashCode) obj).getY()) {
			return true;
		} else {
			return false;
		}
