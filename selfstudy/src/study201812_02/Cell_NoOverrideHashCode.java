...
public class Cell_NoOverrideHashCode {
	private int x;
	private int y;

	public Cell_NoOverrideHashCode(int x, int y) {
		this.x = x;
		this.y = y;
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof Cell_NoOverrideHashCode && this.x == ((Cell_NoOverrideHashCode) obj).getX()
				&& this.y == ((Cell_NoOverrideHashCode) obj).getY()) {
			return true;
		} else {
			return false;
		}
